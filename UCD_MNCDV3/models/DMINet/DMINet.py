...
class DMINet(nn.Module):
    def __init__(self, num_classes=2, drop_rate=0.2, normal_init=True, pretrained=False, show_Feature_Maps=False, in_chans=3):
        ...
        if in_chans==3:
            ...
            # Now your model can take input with `in_channels` channels
