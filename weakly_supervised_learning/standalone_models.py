...
class pspnet(nn.Module):
    ...
    def __init__(
        self, n_channels=10, n_classes=21, block_config=[3, 4, 23, 3], input_size=(473, 473), version=None
    ):
        ...
        self.convbnrelu1_1 = conv2DBatchNormRelu(
            in_channels=n_channels, k_size=3, n_filters=64, padding=1, stride=2, bias=False
        )
...
class linknet(nn.Module):
    ...
    def __init__(self, n_channels=10, n_classes=19):
        """
        Model initialization
        :param x_n: number of input neurons
        :type x_n: int
...
class sqnet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.conv1 = nn.Conv2d(n_channels, 96, kernel_size=3, stride=2, padding=1) # 32
